...
- (void)addRefreshContentView
{
    ...
    _headerCircle = [[CircleView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
    _headerCircle.cirDirection = CircleFromHead;
...
- (void)scrollViewContentOffsetDidChange{
    ...
    if (self.scrollView.isDragging) {   //判断是否正在拖拽
        ...
        [_headerCircle showShapeWithScrollProgress:progress];
