...
//    _circleView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
    ...
    _footerCircle = [[CircleView alloc] initWithFrame:CGRectMake(screenWidth/2.0 - 100, (LoadingOffsetHeight - 40)/2.0 + 5, 30, 30)];
    _footerCircle.cirDirection = CircleFromFoot;
...
- (void)scrollViewContentOffsetDidChange {
    ...
    [_footerCircle  showShapeWithScrollProgress:progress];
